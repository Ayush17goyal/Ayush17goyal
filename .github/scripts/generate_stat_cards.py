...
Usage:
    GITHUB_TOKEN=xxxx GITHUB_USERNAME=Ayush17goyal python3 generate_stat_cards.py
"""
import os, sys, json, math, urllib.request, urllib.error

TOKEN = os.environ.get("GITHUB_TOKEN") or os.environ.get("GH_TOKEN")
USERNAME = os.environ.get("GITHUB_USERNAME", "Ayush17goyal")
